...
import { access, composeEventHandlers, contains, getDocument, isCtrlKey, type MaybeAccessor, noop } from "@ec/kobalte2/utils";
...
export function createInteractOutside<T extends Element>(props: CreateInteractOutsideProps, ref: Accessor<T | undefined>) {
  ...
  const onPointerDown = (e: PointerEvent) => {
    function handler() {
      ...
      const handler = composeEventHandlers([onPointerDownOutside, onInteractOutside]) as EventListener;
