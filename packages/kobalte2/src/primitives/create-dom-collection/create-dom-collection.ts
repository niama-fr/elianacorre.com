...
import { access, addItemToArray, type MaybeAccessor } from "@ec/kobalte2/utils";
import { createComponent, type FlowComponent } from "solid-js";

import { createControllableArraySignal } from "../index";
import { DomCollectionContext, type DomCollectionContextValue } from "./dom-collection-context";
...
export function createDomCollection<T extends DomCollectionItem = DomCollectionItem>(props: CreateDomCollectionProps<T> = {}) {
