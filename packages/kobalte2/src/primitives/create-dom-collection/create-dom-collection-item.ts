import { type MaybeAccessor, mergeDefaultProps } from "@ec/kobalte2/utils";
...
export function createDomCollectionItem<T extends DomCollectionItem = DomCollectionItem>(props: CreateDomCollectionItemProps<T>) {
