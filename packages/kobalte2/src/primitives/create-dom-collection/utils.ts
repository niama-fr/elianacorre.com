...
function setItemsBasedOnDOMPosition<T extends DomCollectionItem>(items: T[], setItems: (items: T[]) => any) {
...
function createTimeoutObserver<T extends DomCollectionItem = DomCollectionItem>(items: Accessor<T[]>, setItems: (items: T[]) => any) {
  createEffect(() => {
