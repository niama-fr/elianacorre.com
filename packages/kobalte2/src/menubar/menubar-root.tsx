...
import { contains, createGenerateId, mergeDefaultProps, mergeRefs, type Orientation, OverrideComponentProps } from "@ec/kobalte2/utils";
import { isServer } from "@solidjs/web";
import { type Accessor, createMemo, createSignal, createUniqueId, onCleanup, type Setter } from "solid-js";

import { type ElementOf, Polymorphic, type PolymorphicProps } from "../polymorphic";
import { createControllableSignal, createInteractOutside } from "../primitives";
import { MenubarContext, type MenubarContextValue, type MenubarDataSet } from "./menubar-context";
...
export function MenubarRoot<T extends ValidComponent = "div">(props: PolymorphicProps<T, MenubarRootProps<T>>) {
  ...
  const mergedProps = mergeDefaultProps({ id: defaultId, loop: true, orientation: "horizontal" }, props as MenubarRootProps);
