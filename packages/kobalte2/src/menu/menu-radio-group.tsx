...
import { MenuGroup, type MenuGroupCommonProps, type MenuGroupRenderProps } from "./menu-group";
...
export interface MenuRadioGroupCommonProps<T extends HTMLElement = HTMLElement> extends MenuGroupCommonProps<T> {
  id: string;
}

export interface MenuRadioGroupRenderProps extends MenuRadioGroupCommonProps, MenuGroupRenderProps {}

export type MenuRadioGroupProps<T extends ValidComponent | HTMLElement = HTMLElement, TValue = string> = MenuRadioGroupOptions<TValue> &
 ...
 */
export function MenuRadioGroup<TValue = string, T extends ValidComponent = "div">(
  ...
  const context: MenuRadioGroupContextValue<TValue> = {
    ...
    setSelectedValue: (value: TValue) => setSelected(value as Exclude<TValue, Function>),
  };
