...
import { focusWithoutScrolling, mergeDefaultProps, removeItemFromArray } from "@ec/kobalte2/utils";
import createPresence from "@ec/solid-presence2";
import { type Accessor, createMemo, createSignal, onCleanup, type ParentProps, Show } from "solid-js";
...
import { type CollectionItemWithRef, createDisclosureState, createHideOutside, createRegisterId } from "../primitives";
...
import { MenuContext, type MenuContextValue, type MenuDataSet, useOptionalMenuContext } from "./menu-context";
  ...
  return (
    <DomCollectionProvider>
      <MenuContext value={context}>
        <Show fallback={others.children} when={optionalNavigationMenuContext === undefined}>
