...
export interface MenuItemDescriptionCommonProps<T extends HTMLElement = HTMLElement> {
  id: string;
}

export interface MenuItemDescriptionRenderProps extends MenuItemDescriptionCommonProps, MenuItemDataSet {}

export type MenuItemDescriptionProps<T extends ValidComponent | HTMLElement = HTMLElement> = MenuItemDescriptionOptions &
 ...
 */
export function MenuItemDescription<T extends ValidComponent = "div">(props: PolymorphicProps<T, MenuItemDescriptionProps<T>>) {
  ...
  return <Polymorphic<MenuItemDescriptionRenderProps> as="div" id={local.id} {...context.dataset()} {...others} />;
}
