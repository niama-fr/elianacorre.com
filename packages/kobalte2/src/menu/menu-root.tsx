import { createGenerateId, mergeDefaultProps, type Orientation } from "@ec/kobalte2/utils";
...
import { MenuRootContext, type MenuRootContextValue } from "./menu-root-context";
...
export function MenuRoot(props: MenuRootProps) {
  ...
  return (
    <MenuRootContext value={context}>
      <Menu onOpenChange={disclosureState.setIsOpen} open={disclosureState.isOpen()} {...others} />
    </MenuRootContext>
  );
}
