...
export interface MenuCheckboxItemCommonProps<T extends HTMLElement = HTMLElement> extends MenuItemBaseCommonProps<T> {}

export interface MenuCheckboxItemRenderProps extends MenuCheckboxItemCommonProps, MenuItemBaseRenderProps {
  role: "menuitemcheckbox";
}

export type MenuCheckboxItemProps<T extends ValidComponent | HTMLElement = HTMLElement> = MenuCheckboxItemOptions &
  Partial<MenuCheckboxItemCommonProps<ElementOf<T>>>;

/**
 * An item that can be controlled and rendered like a checkbox.
 */
export function MenuCheckboxItem<T extends ValidComponent = "div">(props: PolymorphicProps<T, MenuCheckboxItemProps<T>>) {
