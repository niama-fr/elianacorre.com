...
import { visuallyHiddenStyles } from "@ec/kobalte2/utils";
 ...
 */
export function announce(message: string, assertiveness: Assertiveness = "assertive", timeout = LIVEREGION_TIMEOUT_DELAY) {
  if (!liveAnnouncer) {
