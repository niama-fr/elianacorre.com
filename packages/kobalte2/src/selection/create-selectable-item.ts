...
import { access, focusWithoutScrolling, type MaybeAccessor } from "@ec/kobalte2/utils";
 ...
 */
export function createSelectableItem<T extends HTMLElement>(props: CreateSelectableItemProps, ref: Accessor<T | undefined>) {
