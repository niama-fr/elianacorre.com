import { createEffect, mergeProps, on, onMount } from "@ec/kobalte2/utils/solid-compat";
...
import type { FocusStrategy, KeyboardDelegate, MultipleSelectionManager } from "./types";
...
export function createSelectableCollection<T extends HTMLElement, U extends HTMLElement = T>(
  ...
  createEffect(
    on([finalScrollRef, () => access(mergedProps.isVirtualized), () => access(mergedProps.selectionManager).focusedKey()], (newValue) => {
