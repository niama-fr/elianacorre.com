...
import { batch, createEffect, splitProps } from "@ec/kobalte2/utils/solid-compat";
import createPresence from "@ec/solid-presence2";
import type { JSX, ValidComponent } from "@solidjs/web";
import { type Accessor, type Component, createMemo, createSignal, type Setter } from "solid-js";
import type { MenubarRootCommonProps, MenubarRootOptions, MenubarRootRenderProps } from "../menubar";
...
import { NavigationMenuContext, type NavigationMenuContextValue, type NavigationMenuDataSet } from "./navigation-menu-context";
...
export type NavigationMenuRootProps<T extends ValidComponent | HTMLElement = HTMLElement> = NavigationMenuRootOptions &
  Partial<NavigationMenuRootCommonProps<ElementOf<T>>>;

/**
 * A visually persistent menu common in desktop applications that provides quick access to a consistent set of commands.
 */
export function NavigationMenuRoot<T extends ValidComponent = "ul">(props: PolymorphicProps<T, NavigationMenuRootProps<T>>) {
