...
import type { PopperArrowCommonProps, PopperArrowOptions, PopperArrowRenderProps } from "../popper";
import { PopperArrow } from "../popper/popper-arrow";

export interface NavigationMenuArrowOptions extends PopperArrowOptions {}

export interface NavigationMenuArrowCommonProps<T extends HTMLElement = HTMLElement> extends PopperArrowCommonProps<T> {}

export interface NavigationMenuArrowRenderProps extends NavigationMenuArrowCommonProps, PopperArrowRenderProps {}

export type NavigationMenuArrowProps<T extends ValidComponent | HTMLElement = HTMLElement> = NavigationMenuArrowOptions &
 ...
 */
export function NavigationMenuArrow<T extends ValidComponent = "div">(props: PolymorphicProps<T, NavigationMenuArrowProps<T>>) {
  ...
  return (
    <PopperArrow<Component<Omit<NavigationMenuArrowRenderProps, keyof PopperArrowRenderProps>>>
