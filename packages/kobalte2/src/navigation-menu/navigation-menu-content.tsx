...
import { batch, createEffect, on, onMount, splitProps } from "@ec/kobalte2/utils/solid-compat";
import type { JSX, ValidComponent } from "@solidjs/web";
import { type Component, createSignal, onCleanup } from "solid-js";

import { MenuContent, type MenuContentCommonProps, type MenuContentOptions, type MenuContentRenderProps } from "../menu";
...
export interface NavigationMenuContentCommonProps<T extends HTMLElement = HTMLElement> extends MenuContentCommonProps<T> {
...
export type NavigationMenuContentProps<T extends ValidComponent | HTMLElement = HTMLElement> = NavigationMenuContentOptions &
  Partial<NavigationMenuContentCommonProps<ElementOf<T>>>;

export function NavigationMenuContent<T extends ValidComponent = "ul">(props: PolymorphicProps<T, NavigationMenuContentProps<T>>) {
  ...
  return (
    <MenuContent<Component<Omit<NavigationMenuContentRenderProps, keyof MenuContentRenderProps>>>
      as="ul"
      data-motion={motion()}
      onInteractOutside={() => {
