...
import { arrow, autoUpdate, computePosition, flip, hide, type Middleware, offset, platform, shift, size } from "@floating-ui/dom";
import { type Accessor, createSignal, onCleanup, type ParentProps } from "solid-js";

import { useLocale } from "../i18n";
import { PopperContext, type PopperContextValue } from "./popper-context";
import { type AnchorRect, type BasePlacement, getAnchorElement, getTransformOrigin, isValidPlacement, type Placement } from "./utils";
