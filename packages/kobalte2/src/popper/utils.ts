...
export function getAnchorElement(anchor: HTMLElement | undefined, getAnchorRect: (anchor?: HTMLElement) => AnchorRect | undefined) {
...
export function getTransformOrigin(placement: Placement, readingDirection: Direction) {
  const [basePlacement, alignment] = placement.split("-") as [BasePlacement, "start" | "end" | undefined];
