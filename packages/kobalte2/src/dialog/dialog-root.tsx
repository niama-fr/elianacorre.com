import { createGenerateId } from "@ec/kobalte2/utils";
import createPresence from "@ec/solid-presence2";
import { createSignal, createUniqueId, merge, omit, type ParentProps } from "solid-js";
...
export function DialogRoot(props: DialogRootProps) {
  ...
  const mergedProps = merge({ id: defaultId, modal: true, translations: DIALOG_INTL_TRANSLATIONS }, options);
