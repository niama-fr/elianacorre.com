...
Use Better Auth with Convex for administrative and future customer identities. Phase 1 enables Google sign-in only for explicitly authorized
content administrators stored in Convex. ADR 0008 replaces the original Solid application with the supported React integration.
